...
class ProfileModuleUnitTest : KoinTest {
    ...
    fun setup() {
        ...
        startKoin {
            modules(listOf(fakeDependencies, profileModule))
        }
    }
    ...
    @Test
    fun `profile module provides ProfileViewModel`() {
        val savedState = SavedStateHandle()
        val viewModel = get<ProfileViewModel> { parametersOf(savedState) }
